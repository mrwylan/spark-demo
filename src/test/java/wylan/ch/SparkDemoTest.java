...
public class SparkDemoTest {
	...
	public void shouldPut() throws IOException {
		...
		String response = "";
		try(BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(openConnectionR.getInputStream()))){
			String line;
	...
	public void shouldLoadFile() throws IOException{
		...
		String response = "";
		try(BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(openConnection.getInputStream()))){
			String line;
			while((line = bufferedReader.readLine())!= null){
				response = response.concat(line);
			}
